...
public class Totsales{
	public static void main(String[] args){
		...
		listOfSales.add(new Sales("Chair" , 20_000 ,LocalDate.of(2023,Month.JANUARY,1)));
		listOfSales.add(new Sales("Chair" , 10_000 , LocalDate.of(2023,Month.MARCH,19)));
		listOfSales.add(new Sales("Laptop" , 50_000 ,LocalDate.of(2023,Month.JUNE,19)));
		listOfSales.add(new Sales("Table" , 10_000 ,LocalDate.of(2021,Month.APRIL,12)));
		listOfSales.add(new Sales("Table" , 15_000 , LocalDate.of(2012,Month.MARCH,23)));
		listOfSales.add(new Sales("Laptop" , 5_000 , LocalDate.of(2022,Month.DECEMBER,23)));
		...
		listOfSales.stream().filter(sale -> sale.getDate().isBefore(LocalDate.of(2023,1,1))).forEach(sale -> System.out.println(sale));
		System.out.println("-----------------------------------------------------------");
		//group by product
		Map<String,List<Sales>>group = listOfSales.stream().filter(sale -> sale.getDate().isBefore(LocalDate.of(2023,1,1))).collect(Collectors.groupingBy(Sales::getProduct));
